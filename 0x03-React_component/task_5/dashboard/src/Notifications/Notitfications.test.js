...
describe("Notification component tests", () => {
  ...
  it("doesnt re-render when updating the props of the component with the same list", () => {
    const wrapper = shallow(
      <Notifications
        displayDrawer={true}
  ...
  it("re-renders when updating the props of the component with a longer list,", () => {
